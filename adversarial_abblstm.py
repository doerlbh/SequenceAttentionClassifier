...
vocab = ["N","A","C","T","G"]
v_freq = [3053004, 65475094, 58691600, 68810888, 63513614]
...
with graph.as_default():
    ...
    vocab_freqs = tf.constant(v_freq,dtype=tf.float32,shape=(vocab_size,1))
...
with tf.Session(graph=graph) as sess:
    ...
    save_path = saver.save(sess, "./adversarial_abblstm.ckpt")
